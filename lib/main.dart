      ...
      home: Scaffold(
        ...
        body: SafeArea(
          ...
          children: [
            CircleAvatar(
              radius: 50.0,
              backgroundImage: AssetImage('assets/img/20180326_152732.jpg'),
            ),
            Text(
              'Rizkya Fasya',
              style: TextStyle(
...
class Halemail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new Center(
        child: new Text(
          'Email saya = rizkyafasyagmail.com',
          style: (TextStyle(
              color: Colors.white, fontFamily: 'Geosan', fontSize: 20.0)),
        ),
      ),
...
class HalAlamat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new Center(
        child: new Text(
          'Alamat Lengkap = Jln Akasia 3 Blok I',
          style: (TextStyle(
              color: Colors.white, fontFamily: 'Geosan', fontSize: 20.0)),
        ),
      ),
...
class HalHobi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new Center(
        child: new Text(
          'Hobi saya = Jogging Setiap ada waktu luang setelah selesai bekerja ',
          style: (TextStyle(
              color: Colors.white, fontFamily: 'Geosan', fontSize: 20.0)),
        ),
      ),
...
class HalCita extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new Center(
        child: new Text(
          '5 Tahun Kedepan = Ingin Menjadi Wanita Karir',
          style: (TextStyle(
              color: Colors.white, fontFamily: 'Geosan', fontSize: 20.0)),
        ),
      ),
